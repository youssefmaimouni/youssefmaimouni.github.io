...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "contact.lookingForPFE": "Open to Be Hired",
    "contact.pfeDescription": "I'm available and open to be hired for full-time roles, contracts, or freelance opportunities — ready to design and deploy intelligent, high-impact AI solutions.",
    "contact.openForOpportunities": "Available for hire",
    "contact.name": "Name",
    "contact.email": "Email",
  ...
  fr: {
    ...
    "contact.frenchCV": "CV Français",
    "contact.lookingForPFE": "Disponible à l'embauche",
    "contact.pfeDescription": "Je suis disponible et ouvert à l'embauche pour des postes à temps plein, des contrats ou des missions freelance — prêt à concevoir et déployer des solutions IA intelligentes à fort impact.",
    "contact.openForOpportunities": "Disponible à l'embauche",
    "contact.name": "Nom",
    "contact.email": "Email",
