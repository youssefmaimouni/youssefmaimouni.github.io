...
const Index = () => {
  ...
  const featuredProjects: { title: string; description: string; icon: typeof Brain; tags: string[]; github: string; badge?: boolean }[] = [
    ...
    { title: language === "en" ? "Intelligent Shelf Product Detection" : "Détection Intelligente de Produits en Rayon", description: language === "en" ? "Computer vision pipeline for retail shelf analysis. Detection (YOLOv8), segmentation (Mask R-CNN), classification (ResNet-50), validation (ORB + BFMatcher). Cloud deployment and Agile teamwork on large-scale datasets." : "Pipeline de vision par ordinateur pour l'analyse des rayons retail. Détection (YOLOv8), segmentation (Mask R-CNN), classification (ResNet-50), validation (ORB + BFMatcher). Déploiement cloud et travail Agile.", icon: Boxes, tags: ["YOLOv8", "Mask R-CNN", "ResNet-50", "Cloud"], github: "https://github.com/youssefmaimouni/SCINC" },
